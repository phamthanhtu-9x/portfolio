...
const { type, isShow } = defineProps<Props>();
...
<template>
  <div class="toast fixed top-12 right-4 z-50 opacity-0 hidden translate-y-1">
    <div :class="`card is-${type}`">
      ...
      <div class="message-text-container">
        <p class="message-text capitalize">{{ title }}</p>
